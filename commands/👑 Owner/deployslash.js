    ...
    if (message.author.id != "442355791412854784")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only Bishal  is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.gg/FVNBbXHwqQ), open a Ticket and ask for it!`)
        ]
      });
    try {
