                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("BLURPLE")
                                                .setAuthor(`ANTI ADD BOT - Removed Roles of ${AddedMember.user.tag} for adding ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/84393783304212/869285770723217488.png")
                                                .setThumbnail(member.user.displayAvatarURL({
                                                    dynamic: true
                                                }))
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("ORANGE")
                                                .setAuthor(`ANTI ADD BOT - Kicked ${AddedMember.user.tag} for adding ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/85099512688670/hammer_1f528.png")
                                    ...
                                    if (data.all.logger && data.all.logger.length > 5) {
                                        try {
                                            ...
                                            if (ch) {
                                                ch.send({embeds: [new MessageEmbed()
                                                    .setColor("RED")
                                                    .setAuthor(`ANTI ADD BOT - Banned ${AddedMember.user.tag} for adding ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/85114373095514/811556437284749322.png")
                                                    .setThumbnail(member.user.displayAvatarURL({
                                                        dynamic: true
                                                    }))
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI KICK - Removed Roles of ${AddedMember.user.tag} for kicking ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/84393783304212/869285770723217488.png")
                                            .setThumbnail(member.user.displayAvatarURL({
                                                dynamic: true
                                            }))
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI KICK - Kicked ${AddedMember.user.tag} for kicking ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/85099512688670/hammer_1f528.png")
                                            .setThumbnail(member.user.displayAvatarURL({
                                                dynamic: true
                                            }))
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI KICK - Banned ${AddedMember.user.tag} for kicking ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/85114373095514/811556437284749322.png")
                                                .setThumbnail(member.user.displayAvatarURL({
                                                    dynamic: true
                                                }))
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI BAN - Removed Roles of ${AddedMember.user.tag} for banning ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/84393783304212/869285770723217488.png")
                                            .setThumbnail(member.user.displayAvatarURL({
                                                dynamic: true
                                            }))
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI BAN - Kicked ${AddedMember.user.tag} for banning ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/85099512688670/hammer_1f528.png")
                                            .setThumbnail(member.user.displayAvatarURL({
                                                dynamic: true
                                            }))
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI BAN - Banned ${AddedMember.user.tag} for banning ${member.user.tag}`, "https://cdn.discordapp.com/attachments/820695790170275871/85114373095514/811556437284749322.png")
                                                .setThumbnail(member.user.displayAvatarURL({
                                                    dynamic: true
                                                }))
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI CHANNEL CREATE - Removed Roles of ${AddedMember.user.tag} for creating ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/84393783304212/869285770723217488.png")
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI CHANNEL CREATE - Kicked ${AddedMember.user.tag} for creating ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/85099512688670/hammer_1f528.png")
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI CHANNEL CREATE - Banned ${AddedMember.user.tag} for creating ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/85114373095514/811556437284749322.png")
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI CHANNEL DELETE - Removed Roles of ${AddedMember.user.tag} for deleting ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/84393783304212/869285770723217488.png")
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI CHANNEL DELETE - Kicked ${AddedMember.user.tag} for deleting ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/85099512688670/hammer_1f528.png")
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI CHANNEL DELETE - Banned ${AddedMember.user.tag} for deleting ${channel.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/85114373095514/811556437284749322.png")
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI ROLE CREATE - Removed Roles of ${AddedMember.user.tag} for creating ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/84393783304212/869285770723217488.png")
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI ROLE CREATE - Kicked ${AddedMember.user.tag} for creating ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/85099512688670/hammer_1f528.png")
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI ROLE CREATE - Banned ${AddedMember.user.tag} for creating ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/85114373095514/811556437284749322.png")
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("BLURPLE")
                                            .setAuthor(`ANTI ROLE DELETE - Removed Roles of ${AddedMember.user.tag} for deleting ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/84393783304212/869285770723217488.png")
                            ...
                            if (data.all.logger && data.all.logger.length > 5) {
                                try {
                                    ...
                                    if (ch) {
                                        ch.send({embeds: [new MessageEmbed()
                                            .setColor("ORANGE")
                                            .setAuthor(`ANTI ROLE DELETE - Kicked ${AddedMember.user.tag} for deleting ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/85099512688670/hammer_1f528.png")
                                ...
                                if (data.all.logger && data.all.logger.length > 5) {
                                    try {
                                        ...
                                        if (ch) {
                                            ch.send({embeds: [new MessageEmbed()
                                                .setColor("RED")
                                                .setAuthor(`ANTI ROLE DELETE - Banned ${AddedMember.user.tag} for deleting ${role.name}`, "https://cdn.discordapp.com/attachments/820695790170275871/85114373095514/811556437284749322.png")
